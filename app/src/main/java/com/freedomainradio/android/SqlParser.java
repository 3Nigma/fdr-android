...
/* Author: Michenux
 * Url: http://www.michenux.net/android-database-sqlite-creation-upgrade-245.html */
...
public class SqlParser {
    ...
    public static List<String> parseSqlFile(InputStream sqlInputStream, AssetManager assetManager) throws IOException {
        List<String> sqlIns = null;
        try {
            sqlIns = parseSqlFile(sqlInputStream);
        } finally {
